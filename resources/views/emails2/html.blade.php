<div style='width:100%; background-color:rgb(246,243,241); padding: 50px 0'>
    <div style='width:78%; background-color:rgb(255,255,255); margin-left: auto; margin-right: auto;padding:20px;'>
        ...
        <div style='font-size:1.3em;  padding: 0 15px'>Estimado(a) <strong>{{$data['cliente']}}</strong>, su cotización a sido realizada con é
        xito, pronto nos pondremos en contacto con usted.</div><br>
        <div style='text-align:left;'>
